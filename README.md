...
## [Terrain types](https://github.com/cxong/MagusPreservation/blob/master/source/MAPMAKE.C#L121)
- Door (Dörr)
- Gate (Port)
- Grass (Gräs)
- Water (H2O)
- Stones in water (Stenar i vatten)
- Stone pavement (Stenplatta)
- Earth (Jord)
- Red flower (Röd blomma)
- Wooden floor (Trägolv)
- Yellow flower (Gul blomma)
- Sand (Sand)
- Bush (Buske)
- Palm tree (Palm)
- Marsh (Sankmark)
...
- Stone wall (Stenmur)
- Portal (Portal)
- Brick wall (Tegelvägg)
- Mountain (Berg)
- Gravel (Grus)
- Planks (Plankor)
- Wooden wall (Trävägg)
- Cobblestone pavement (Stenplatta)
